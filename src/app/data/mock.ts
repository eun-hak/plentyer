...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    summary: '연패는 실력보다 멘탈이 먼저 무너지는 구간에서 길어진다. 연패 중 흔히 무너지는 판단 순서(무리한 리테이크, 혼자 캐리하려는 습관, 급해진 샷)를 짚고, 즉시 적용 가능한 "연패 차단 루틴"으로 흐름을 되돌리는 방법을 정리한다.',
    content: POST_CONTENTS['fps-losing-streak-reset-guide'],
    category: 'strategy',
    date: '2026-02-01',
    slug: 'fps-losing-streak-reset-guide',
    views: 0,
    tags: ['FPS', '멘탈', '연패', '틸트', '랭크', '전략'],
    readingTime: 6
  },
  {
    id: '21',
